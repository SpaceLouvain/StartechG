<script>
    ...
    function nextQuestion() {
        if (currentQuestion < questions.length - 1) {
            ...
            // You can use Svelte's built-in router or any other method to handle the redirection
        }
    }
    let currentQuestion = 0;
    let currentVideoUrl = questions[currentQuestion].lien;
    
    function handleImageClick() {
        currentVideoUrl = questions[currentQuestion].lien;
    }

</script>
<a href="/video" class="image-link" on:click={handleImageClick}>
...
<main>
    ...
    {#if currentQuestion < questions.length}
        ...
        <div class="answer-container">
            ...
            class:correct={questions[currentQuestion].selectedAnswer === index && index === questions[currentQuestion].correctAnswer}
            class:incorrect={questions[currentQuestion].selectedAnswer === index && index !== questions[currentQuestion].correctAnswer}
        >
            {answer}
        </button>
            {/each}
